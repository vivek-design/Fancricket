...
class matchtileforstart extends StatefulWidget {
  contests cont;
  matchtileforstart({
    Key? key,
    required this.cont,
  ...
  @override
  State<matchtileforstart> createState() => _matchtileforstartState();
}

class _matchtileforstartState extends State<matchtileforstart> {
  @override
